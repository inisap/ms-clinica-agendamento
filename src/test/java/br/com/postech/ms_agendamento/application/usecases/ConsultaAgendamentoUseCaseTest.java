...
public class ConsultaAgendamentoUseCaseTest {
    ...
    void consultaListaAgendamentosPorLoginRealizadaSucesso(){
        ...
        when(agendamentoRepositoryPortOut.findAll()).thenReturn(agendamentoEntityList);

        //act
        var retorno = consultaAgendamentoUseCase.listarHistorico();
    ...
    @Test
    void consultaListaAgendamentosPorLoginRealizadaSucessoSemDadosParaRetorno(){
        when(agendamentoRepositoryPortOut.findAll()).thenReturn(new ArrayList<>());
